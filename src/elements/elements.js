...
const Elements = () => {
    return (
        <Box sx={{ borderBottom:3, borderColor:"#EEEFF5", boxShadow: 2, mb : 2, padding:"10px"}} >
                <Typography sx={{mb:"10px"}}>Éléments:</Typography>
                <Grid container>
                <Grid container sx={{"backgroundColor": "rgba(0, 0, 0, 0.08)"}}>
                    <Grid item xs={7} sx={{display:"flex",justifyContent:"start",alignItems:"center"}}>
                        <Typography variant="subtitle1">1. Rectangle</Typography>
                    </Grid>
                    <Grid item xs={4} sx={{display:"flex",alignItems:"center"}}>
                    <button tabIndex="0" type="button" className={ElementsCSS.MuiButtonBaseRoot}>
                                    <span>
                                ...
                                <button tabIndex="0" type="button" title="Sélectionner" className={ElementsCSS.MuiButtonBaseRoot}>
                                    <span><svg className={ElementsCSS.buttonArea} stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <button tabIndex="0" type="button" title="Supprimer" className={ElementsCSS.MuiButtonBaseRoot}>
                                    <span>
